...
Options:
  ...
  -p, --packaging <type>          打包类型: jar / war（默认自动检测）
      ...
      --byte-exact-package        对 Maven package 产物执行字节级保真修复与验证
